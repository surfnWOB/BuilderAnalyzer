...
if downloadPokedex:
    ...
    urlPokedex = 'https://raw.githubusercontent.com/smogon/pokemon-showdown/master/data/pokedex.ts'
    urllib.request.urlretrieve(urlPokedex, 'pokedex.ts')
    print('Beginning items download...')
    urlItems = 'https://raw.githubusercontent.com/smogon/pokemon-showdown/master/data/items.ts'
    urllib.request.urlretrieve(urlItems, 'items.ts')
    print('Beginning moves download...')
    urlMoves = 'https://raw.githubusercontent.com/smogon/pokemon-showdown/master/data/moves.ts'
    urllib.request.urlretrieve(urlMoves, 'moves.ts')
    print('Beginning abilities download...')
    urlAbilities = 'https://raw.githubusercontent.com/smogon/pokemon-showdown/master/data/abilities.ts'
    urllib.request.urlretrieve(urlAbilities, 'abilities.ts')
    

pokedexFile = open('pokedex.ts')
pokedexStr = pokedexFile.read()
itemsFile = open('items.ts')
itemsStr = itemsFile.read()
movesFile = open('moves.ts')
movesStr = movesFile.read()
abilitiesFile = open('abilities.ts')
    ...
    if inputFormatDense:
        ...
        if indexDelimiter1 + 1 < indexDelimiter2:
            ...
            if indexNameKey == -1: # Alternate Form
                ...
                indexSpecies = pokedexStr.rfind('name: ',0,indexNameKey)
                ...
                indexSpecies = pokedexStr.find('name: ',indexNameKey)
